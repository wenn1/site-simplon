						...
						<h3 class="preambule_main">La formation Dévelo'pont</h3>
							<section class="preambule">
								 <h4 class="preambule_main2">Présentation</h4>
										...
										<p>L'entreprise Legrand accueille la formation sur son site de Pont-en-Royans.<br> Elle met à disposition plusieurs salles (cours, repos, administration) ainsi que l'accès à la cafétéria, de manière à offrir un cadre adapté pour répondre aux besoins des futurs développeurs.</p>
							</section>
					</article>
					<!-- Partie latérale -->
