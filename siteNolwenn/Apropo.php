		...
		<main id="main" role="main">
		  ...
		  <section class="apropo_presentation">
			  ...
			  <article>	
				  ...
				  <p>Ce projet a été realisé en 2 semaines dans le cadre de la réalisation d'un site web par
				  groupe de 5 personnes. Nous avons fait usage du plateau SCRUM pour coordonner le travail.</p>
			  </article>
		  </section>
			    </main>
